          ...
          <?php if (!empty($orders)): ?>
            <?php foreach ($orders as $order): ?>
              <tr class="border-b hover:bg-gray-700 transition-all duration-200">
                <td class="px-6 py-4 text-gray-200"><?= htmlspecialchars($order['orderer_name']); ?></td>
                <td class="px-6 py-4 text-gray-200"><?= htmlspecialchars($order['menu_name']); ?></td>
                <td class="px-6 py-4 text-gray-200"><?= htmlspecialchars($order['quantity']); ?></td>
                <td class="px-6 py-4 text-gray-200"><?= htmlspecialchars($order['table_number']); ?></td>
