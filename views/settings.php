...
<body class="bg-gray-900 font-sans leading-normal tracking-normal text-gray-200">
    <div class="max-w-2xl mx-auto mt-20 p-8 bg-gray-800 rounded-xl shadow-lg">
        ...
        <form action="../controllers/UpdatePasswordController.php" method="POST">
            ...
            <div class="mb-6">
                <button type="submit" name="submit" class="w-full bg-yellow-600 text-white font-semibold py-3 rounded-lg hover:bg-yellow-700 transition duration-300 focus:outline-none focus:ring-2 focus:ring-yellow-500">Update Password</button>
            </div>
        </form>
    </div>
