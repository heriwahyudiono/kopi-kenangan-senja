          ...
          <div class="flex justify-center gap-4 mb-4">
            <form action="../../controllers/AddChartController.php" method="POST">
              <a
                ...
                <button type="submit" class="text-yellow-500 bg-gray-900 p-3 rounded-full hover:bg-yellow-500 hover:text-gray-900 transition duration-300 ease-in-out add-to-cart"><i data-feather="shopping-cart"></i></button>
              </a>
            </form>
            <button
